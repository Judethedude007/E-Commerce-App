      ...
      <div className="bg-white flex flex-col rounded-lg shadow-lg overflow-hidden max-w-md w-full p-6 sm:p-10">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex justify-between text-sm mb-6 mt-3">
            <a href="#" className="text-green-600 hover:text-red-600 transition-colors duration-300">
              Forgot password?
            </a>
          </div>
          <button
        ...
        <button
          ...
          className="w-full flex items-center justify-center py-2.5 rounded-lg bg-white border-2 border-green-600 text-black hover:bg-green-100 duration-100"
        >
